...
# ATUALIZADO para usar o SDK do .NET 9.0
FROM mcr.microsoft.com/dotnet/sdk:9.0 AS build
WORKDIR /src

# Copia os arquivos .csproj e restaura as dependências
# ATENÇÃO: Se o nome do seu projeto não for "UnimindAPI.csproj", ajuste abaixo.
COPY *.csproj .
RUN dotnet restore
...
# ATUALIZADO para usar o runtime do ASP.NET 9.0
...
# ATENÇÃO: Se o nome da sua DLL não for "UnimindAPI.dll", ajuste abaixo.
